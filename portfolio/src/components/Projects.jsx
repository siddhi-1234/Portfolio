...
const Projects = () => {
  ...
  const projects = [
    ...
    {
      title: "UX Pulse-AI",
      highlight: "An intelligent tool for UX designers",
      challenge:
        "Creating a tool that can analyze user experience designs and provide actionable insights using AI",
      solution:
        "Identifies potential user confusion in interface designs—before real users interact with them. By leveraging the power of AI, this application analyzes UI screenshots and highlights areas where users are likely to hesitate, misunderstand, or make errors.",
      tags: ["React", "Tailwind CSS", "JavaScript"],
      github: "https://github.com/siddhi-1234/uxpulse-ai",
      image:
        "https://www.softimpact.net/ExtImages/Ext1/638411852328336975-1_j7TiBo6BraFMeXme9BHCcw.jpg",
      gallery: [
        "./Uxpulse-home.png",
        "./Uxpulse-home1.png",
        "./Uxpulse-analyze.png",
        "./Uxpulse-identifyError.png",
        "./Uxpulse-CTA.png",
      ],
    },
    {
